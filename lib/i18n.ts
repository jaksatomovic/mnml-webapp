...
export const SUPPORTED_LOCALES = ["en", "hr", "zh"] as const;
...
export function pickByLocale<T>(
  locale: Locale,
  values: { en: T; zh?: T; hr?: T },
): T {
  if (locale === "zh" && values.zh !== undefined) return values.zh;
  if (locale === "hr" && values.hr !== undefined) return values.hr;
  return values.en;
}
