...
import { pickByLocale, t } from "@/lib/i18n";
...
async function readDocMarkdown(fileName: string, locale: "zh" | "en" | "hr"): Promise<string | null> {
  try {
    const filePath = locale !== "zh"
...
export default async function DocSlugPage({
  ...
  const imageAlt = pickByLocale(locale, { zh: "QQ群", en: "QQ Group", hr: "QQ grupa" });
          ...
          h1: ({...props}) => (
            <div className="flex items-center justify-between gap-4 mb-8">
              ...
              <div className="flex-shrink-0">
                <Image
                  src={locale !== "zh" ? "/images/QQ_EN.jpg" : "/images/QQ.jpg"}
                  alt={imageAlt}
                  width={192}
                  height={96}
